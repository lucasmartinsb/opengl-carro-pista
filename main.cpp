...
int main()
{
    ...
    float carroVertices[] = {
        1.55f, 1.0f, -0.5f, 0.875f, 0.5f,
        2.55f, 1.0f, 0.5f, 0.625f, 0.75f,
        2.55f, 1.0f, -0.5f, 0.625f, 0.5f,
        2.55f, 1.0f, 0.5f, 0.625f, 0.75f,
        1.55f, 0.0f, 0.5f, 0.375f, 1.0f,
        2.55f, 0.0f, 0.5f, 0.375f, 0.75f,
        1.55f, 1.0f, 0.5f, 0.625f, 0.0f,
        1.55f, 0.0f, -0.5f, 0.375f, 0.25f,
        1.55f, 0.0f, 0.5f, 0.375f, 0.0f,
        2.55f, 0.0f, -0.5f, 0.375f, 0.5f,
        1.55f, 0.0f, 0.5f, 0.125f, 0.75f,
        1.55f, 0.0f, -0.5f, 0.125f, 0.5f,
        2.55f, 1.0f, -0.5f, 0.625f, 0.5f,
        2.55f, 0.0f, 0.5f, 0.375f, 0.75f,
        2.55f, 0.0f, -0.5f, 0.375f, 0.5f,
        1.55f, 1.0f, -0.5f, 0.625f, 0.25f,
        2.55f, 0.0f, -0.5f, 0.375f, 0.5f,
        1.55f, 0.0f, -0.5f, 0.375f, 0.25f,
        1.55f, 1.0f, -0.5f, 0.875f, 0.5f,
        1.55f, 1.0f, 0.5f, 0.875f, 0.75f,
        2.55f, 1.0f, 0.5f, 0.625f, 0.75f,
        2.55f, 1.0f, 0.5f, 0.625f, 0.75f,
        1.55f, 1.0f, 0.5f, 0.625f, 1.0f,
        1.55f, 0.0f, 0.5f, 0.375f, 1.0f,
        1.55f, 1.0f, 0.5f, 0.625f, 0.0f,
        1.55f, 1.0f, -0.5f, 0.625f, 0.25f,
        1.55f, 0.0f, -0.5f, 0.375f, 0.25f,
        ...
        2.55f, 1.0f, -0.5f, 0.625f, 0.5f,
        2.55f, 0.0f, -0.5f, 0.375f, 0.5f,
        -2.0f, 4.45f, -6.22f, 0.875f, 0.5f,
        2.5f, 4.45f, -0.22f, 0.625f, 0.75f,
        2.5f, 4.45f, -6.22f, 0.625f, 0.5f,
        2.5f, 4.45f, -0.22f, 0.625f, 0.75f,
        -2.0f, 3.05f, -0.22f, 0.375f, 1.0f,
        2.5f, 3.05f, -0.22f, 0.375f, 0.75f,
        -2.0f, 4.45f, -0.22f, 0.625f, 0.0f,
        -2.0f, 3.05f, -6.22f, 0.375f, 0.25f,
        -2.0f, 3.05f, -0.22f, 0.375f, 0.0f,
        2.5f, 3.05f, -6.22f, 0.375f, 0.5f,
        -2.0f, 3.05f, -0.22f, 0.125f, 0.75f,
        -2.0f, 3.05f, -6.22f, 0.125f, 0.5f,
        2.5f, 4.45f, -6.22f, 0.625f, 0.5f,
        2.5f, 3.05f, -0.22f, 0.375f, 0.75f,
        2.5f, 3.05f, -6.22f, 0.375f, 0.5f,
        -2.0f, 4.45f, -6.22f, 0.625f, 0.25f,
        2.5f, 3.05f, -6.22f, 0.375f, 0.5f,
        -2.0f, 3.05f, -6.22f, 0.375f, 0.25f,
        -2.0f, 4.45f, -6.22f, 0.875f, 0.5f,
        -2.0f, 4.45f, -0.22f, 0.875f, 0.75f,
        2.5f, 4.45f, -0.22f, 0.625f, 0.75f,
        2.5f, 4.45f, -0.22f, 0.625f, 0.75f,
        -2.0f, 4.45f, -0.22f, 0.625f, 1.0f,
        -2.0f, 3.05f, -0.22f, 0.375f, 1.0f,
        -2.0f, 4.45f, -0.22f, 0.625f, 0.0f,
        -2.0f, 4.45f, -6.22f, 0.625f, 0.25f,
        -2.0f, 3.05f, -6.22f, 0.375f, 0.25f,
        ...
        2.5f, 4.45f, -6.22f, 0.625f, 0.5f,
        2.5f, 3.05f, -6.22f, 0.375f, 0.5f,
        1.55f, 1.0f, -6.5f, 0.875f, 0.5f,
        2.55f, 1.0f, -5.5f, 0.625f, 0.75f,
        2.55f, 1.0f, -6.5f, 0.625f, 0.5f,
        2.55f, 1.0f, -5.5f, 0.625f, 0.75f,
        1.55f, 0.0f, -5.5f, 0.375f, 1.0f,
        2.55f, 0.0f, -5.5f, 0.375f, 0.75f,
        1.55f, 1.0f, -5.5f, 0.625f, 0.0f,
        1.55f, 0.0f, -6.5f, 0.375f, 0.25f,
        1.55f, 0.0f, -5.5f, 0.375f, 0.0f,
        2.55f, 0.0f, -6.5f, 0.375f, 0.5f,
        1.55f, 0.0f, -5.5f, 0.125f, 0.75f,
        1.55f, 0.0f, -6.5f, 0.125f, 0.5f,
        2.55f, 1.0f, -6.5f, 0.625f, 0.5f,
        2.55f, 0.0f, -5.5f, 0.375f, 0.75f,
        2.55f, 0.0f, -6.5f, 0.375f, 0.5f,
        1.55f, 1.0f, -6.5f, 0.625f, 0.25f,
        2.55f, 0.0f, -6.5f, 0.375f, 0.5f,
        1.55f, 0.0f, -6.5f, 0.375f, 0.25f,
        1.55f, 1.0f, -6.5f, 0.875f, 0.5f,
        1.55f, 1.0f, -5.5f, 0.875f, 0.75f,
        2.55f, 1.0f, -5.5f, 0.625f, 0.75f,
        2.55f, 1.0f, -5.5f, 0.625f, 0.75f,
        1.55f, 1.0f, -5.5f, 0.625f, 1.0f,
        1.55f, 0.0f, -5.5f, 0.375f, 1.0f,
        1.55f, 1.0f, -5.5f, 0.625f, 0.0f,
        1.55f, 1.0f, -6.5f, 0.625f, 0.25f,
        1.55f, 0.0f, -6.5f, 0.375f, 0.25f,
        ...
        2.55f, 1.0f, -6.5f, 0.625f, 0.5f,
        2.55f, 0.0f, -6.5f, 0.375f, 0.5f,
        -2.05f, 1.0f, -0.5f, 0.875f, 0.5f,
        -1.05f, 1.0f, 0.5f, 0.625f, 0.75f,
        -1.05f, 1.0f, -0.5f, 0.625f, 0.5f,
        -1.05f, 1.0f, 0.5f, 0.625f, 0.75f,
        -2.05f, 0.0f, 0.5f, 0.375f, 1.0f,
        -1.05f, 0.0f, 0.5f, 0.375f, 0.75f,
        -2.05f, 1.0f, 0.5f, 0.625f, 0.0f,
        -2.05f, 0.0f, -0.5f, 0.375f, 0.25f,
        -2.05f, 0.0f, 0.5f, 0.375f, 0.0f,
        -1.05f, 0.0f, -0.5f, 0.375f, 0.5f,
        -2.05f, 0.0f, 0.5f, 0.125f, 0.75f,
        -2.05f, 0.0f, -0.5f, 0.125f, 0.5f,
        -1.05f, 1.0f, -0.5f, 0.625f, 0.5f,
        -1.05f, 0.0f, 0.5f, 0.375f, 0.75f,
        -1.05f, 0.0f, -0.5f, 0.375f, 0.5f,
        -2.05f, 1.0f, -0.5f, 0.625f, 0.25f,
        -1.05f, 0.0f, -0.5f, 0.375f, 0.5f,
        -2.05f, 0.0f, -0.5f, 0.375f, 0.25f,
        -2.05f, 1.0f, -0.5f, 0.875f, 0.5f,
        -2.05f, 1.0f, 0.5f, 0.875f, 0.75f,
        -1.05f, 1.0f, 0.5f, 0.625f, 0.75f,
        -1.05f, 1.0f, 0.5f, 0.625f, 0.75f,
        -2.05f, 1.0f, 0.5f, 0.625f, 1.0f,
        -2.05f, 0.0f, 0.5f, 0.375f, 1.0f,
        -2.05f, 1.0f, 0.5f, 0.625f, 0.0f,
        -2.05f, 1.0f, -0.5f, 0.625f, 0.25f,
        -2.05f, 0.0f, -0.5f, 0.375f, 0.25f,
        ...
        -1.05f, 1.0f, -0.5f, 0.625f, 0.5f,
        -1.05f, 0.0f, -0.5f, 0.375f, 0.5f,
        -2.05f, 1.0f, -6.5f, 0.875f, 0.5f,
        -1.05f, 1.0f, -5.5f, 0.625f, 0.75f,
        -1.05f, 1.0f, -6.5f, 0.625f, 0.5f,
        -1.05f, 1.0f, -5.5f, 0.625f, 0.75f,
        -2.05f, 0.0f, -5.5f, 0.375f, 1.0f,
        -1.05f, 0.0f, -5.5f, 0.375f, 0.75f,
        -2.05f, 1.0f, -5.5f, 0.625f, 0.0f,
        -2.05f, 0.0f, -6.5f, 0.375f, 0.25f,
        -2.05f, 0.0f, -5.5f, 0.375f, 0.0f,
        -1.05f, 0.0f, -6.5f, 0.375f, 0.5f,
        -2.05f, 0.0f, -5.5f, 0.125f, 0.75f,
        -2.05f, 0.0f, -6.5f, 0.125f, 0.5f,
        -1.05f, 1.0f, -6.5f, 0.625f, 0.5f,
        -1.05f, 0.0f, -5.5f, 0.375f, 0.75f,
        -1.05f, 0.0f, -6.5f, 0.375f, 0.5f,
        -2.05f, 1.0f, -6.5f, 0.625f, 0.25f,
        -1.05f, 0.0f, -6.5f, 0.375f, 0.5f,
        -2.05f, 0.0f, -6.5f, 0.375f, 0.25f,
        -2.05f, 1.0f, -6.5f, 0.875f, 0.5f,
        -2.05f, 1.0f, -5.5f, 0.875f, 0.75f,
        -1.05f, 1.0f, -5.5f, 0.625f, 0.75f,
        -1.05f, 1.0f, -5.5f, 0.625f, 0.75f,
        -2.05f, 1.0f, -5.5f, 0.625f, 1.0f,
        -2.05f, 0.0f, -5.5f, 0.375f, 1.0f,
        -2.05f, 1.0f, -5.5f, 0.625f, 0.0f,
        -2.05f, 1.0f, -6.5f, 0.625f, 0.25f,
        -2.05f, 0.0f, -6.5f, 0.375f, 0.25f,
        ...
        -1.05f, 1.0f, -6.5f, 0.625f, 0.5f,
        -1.05f, 0.0f, -6.5f, 0.375f, 0.5f,
        -2.25f, 3.0f, -7.0f, 0.875f, 0.5f,
        2.75f, 3.0f, 1.0f, 0.625f, 0.75f,
        2.75f, 3.0f, -7.0f, 0.625f, 0.5f,
        2.75f, 3.0f, 1.0f, 0.625f, 0.75f,
        -2.25f, 1.0f, 1.0f, 0.375f, 1.0f,
        2.75f, 1.0f, 1.0f, 0.375f, 0.75f,
        -2.25f, 3.0f, 1.0f, 0.625f, 0.0f,
        -2.25f, 1.0f, -7.0f, 0.375f, 0.25f,
        -2.25f, 1.0f, 1.0f, 0.375f, 0.0f,
        2.75f, 1.0f, -7.0f, 0.375f, 0.5f,
        -2.25f, 1.0f, 1.0f, 0.125f, 0.75f,
        -2.25f, 1.0f, -7.0f, 0.125f, 0.5f,
        2.75f, 3.0f, -7.0f, 0.625f, 0.5f,
        2.75f, 1.0f, 1.0f, 0.375f, 0.75f,
        2.75f, 1.0f, -7.0f, 0.375f, 0.5f,
        -2.25f, 3.0f, -7.0f, 0.625f, 0.25f,
        2.75f, 1.0f, -7.0f, 0.375f, 0.5f,
        -2.25f, 1.0f, -7.0f, 0.375f, 0.25f,
        -2.25f, 3.0f, -7.0f, 0.875f, 0.5f,
        -2.25f, 3.0f, 1.0f, 0.875f, 0.75f,
        2.75f, 3.0f, 1.0f, 0.625f, 0.75f,
        2.75f, 3.0f, 1.0f, 0.625f, 0.75f,
        -2.25f, 3.0f, 1.0f, 0.625f, 1.0f,
        -2.25f, 1.0f, 1.0f, 0.375f, 1.0f,
        -2.25f, 3.0f, 1.0f, 0.625f, 0.0f,
        -2.25f, 3.0f, -7.0f, 0.625f, 0.25f,
        -2.25f, 1.0f, -7.0f, 0.375f, 0.25f,
